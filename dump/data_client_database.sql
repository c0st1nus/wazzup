...
INSERT INTO "public"."users" ("id", "name", "login", "email", "password_hash", "salt", "role", "resource_id", "location_id") VALUES
(1, 'Системный администратор', 'admin', 'admin@example.com', 
 'c7ad44cbad762a5da0a452f9e854fdc1e0e7a52a38015f23f3eab1d80b931dd472634dfac71cd34ebc35d16ab7fb8a90c81f975113d6c7538dc69dd8de9077ec', 
 'admin_salt_2025', 'admin', NULL, NULL),
(2, 'Менеджер Анна Петрова', 'manager', 'manager@example.com',
 ...
 'manager_salt_2025', 'manager', NULL, NULL),
(3, 'Сотрудник ОКК Иван Сидоров', 'quality_control', 'qc@example.com',
 ...
 'qc_salt_2025', 'quality_control', NULL, NULL),
