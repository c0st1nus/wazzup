...
-- Schema: public
ALTER TABLE "public"."responsibilites" ADD CONSTRAINT "fk_responsibilites_user_clients_id" FOREIGN KEY("user") REFERENCES "public"."clients"("id");
...
ALTER TABLE "public"."users" ADD CONSTRAINT "fk_users_location_locations_id" FOREIGN KEY("location") REFERENCES "public"."locations"("id");
ALTER TABLE "public"."locations" ADD CONSTRAINT "fk_locations_resource_resources_id" FOREIGN KEY("resource") REFERENCES "public"."resources"("id");
ALTER TABLE "public"."responsibilites" ADD CONSTRAINT "fk_responsibilites_user_users_id" FOREIGN KEY("user") REFERENCES "public"."users"("id");
